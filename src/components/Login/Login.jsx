...
export default function Login() {
  ...
  return (
    <div>
      <h2 className='text-3xl font-semibold text-center lg:pt-6 pb-4'>Login</h2>
      <hr/>
      <form onSubmit={formik.handleSubmit} className='w-1/2 mx-auto py-8'>
        ...
        </button> : <button type="submit" className="text-white bg-emerald-600 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800 lg:text-lg">Login</button>
          }
      </form>
    </div>
  )
